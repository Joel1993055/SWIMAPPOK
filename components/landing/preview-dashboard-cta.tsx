        ...
        <CardContent className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4">
              ...
              <p className="text-sm text-muted-foreground">Visualizaciones con Recharts</p>
            </div>
            <div className="text-center p-4">
              <Users className="w-12 h-12 text-primary mx-auto mb-3" />
              <h3 className="font-semibold mb-2">Análisis de Sesiones</h3>
              <p className="text-sm text-muted-foreground">Tabla con búsqueda y paginación</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="text-lg px-8 py-6">
              <Link href="/preview-dashboard" aria-label="Ver dashboard de vista previa">
            ...
            <Button asChild variant="outline" size="lg" className="text-lg px-8 py-6">
              <Link href="/dashboard-demo" aria-label="Ver dashboard demo profesional">
