        ...
        <form onSubmit={handleFormSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  step="100"
                  value={data?.distance || ''}
                  onChange={(e) => setField('distance', parseInt(e.target.value) || 0)}
                  placeholder="e.g., 2000"
                  className={hasFieldError('distance') ? 'border-red-500' : ''}
                />
                {hasFieldError('distance') && (
                  <p className="text-sm text-red-500">{getFieldError('distance')}</p>
                )}
              </div>
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className={hasFieldError('rpe') ? 'border-red-500' : ''}>
