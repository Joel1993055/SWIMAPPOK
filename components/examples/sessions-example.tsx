...
import { useSessions, useSessionsPagination, useSessionsStats } from '@/lib/hooks/use-sessions'
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold">{(getTotalDistance() / 1000).toFixed(1)}km</div>
              <div className="text-sm text-muted-foreground">Distancia Total</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold">{getAverageRPE().toFixed(1)}</div>
