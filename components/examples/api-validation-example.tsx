    ...
    <div className='max-w-4xl mx-auto p-6 space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fill in the form below. Data will be validated before sending to the
            API.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleFormSubmit} className='space-y-4'>
            ...
            {error && (
              <Alert variant='destructive'>
                <XCircleIcon className='h-4 w-4' />
                <AlertDescription>API Error: {error.message}</AlertDescription>
              </Alert>
            )}
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  value={formData.rpe || ''}
                  onChange={e =>
                    handleFieldChange('rpe', parseInt(e.target.value) || 0)
                  }
                  placeholder='e.g., 7'
                />
              </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Current validation state and errors</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <div className='flex justify-between items-start'>
                    <div>
                      ...
                      <p className='text-sm text-gray-600'>
                        ...
                        {session.distance}m • {session.duration}min • RPE{' '}
                        {session.rpe}
                      </p>
                    </div>
