...
export default function Features() {
  ...
  return (
    <section 
      className="px-12 md:px-24 py-24 bg-black"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16">
        ...
        <div className="space-y-4">
          {tabs.map((tab, index) => (
            ...
            >
              ...
              <div>
                <h3 className="text-white font-semibold text-lg mb-2">{tab.title}</h3>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div 
            ...
            style={{
              background: 'radial-gradient(circle, rgba(29, 78, 216, 0.4) 0%, rgba(30, 64, 175, 0.2) 50%, transparent 100%)'
            }}
          />
