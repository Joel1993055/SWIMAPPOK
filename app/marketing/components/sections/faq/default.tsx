...
const defaultItems: BentoGridItem[] = [
  {
    ...
    description: 'Track performance metrics with detailed insights and real-time data visualization.',
    icon: '',
  ...
  },
  {
    ...
    description: 'Personalized workout routines designed by professional swimming coaches.',
    icon: '‍♂️',
  ...
  },
  {
    ...
    description: 'Monitor your improvement with comprehensive progress reports and milestones.',
    icon: '',
    className: 'col-span-1',
  },
  {
    id: 'community',
    title: 'Community',
    description: 'Connect with fellow swimmers and share achievements in our vibrant community.',
    icon: '',
    className: 'col-span-1 md:col-span-2',
  },
  {
    ...
    description: 'Optimize your performance with tailored nutrition recommendations and meal plans.',
    icon: '',
    className: 'col-span-1',
  },
  {
    id: 'competitions',
    title: 'Competitions',
    description: 'Participate in virtual competitions and track your ranking against other swimmers.',
    icon: '',
    className: 'col-span-1',
  },
];
