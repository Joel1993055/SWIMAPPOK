...
test.describe('Marketing Page', () => {
  ...
  test('should display hero section with correct content', async ({ page }) => {
    // Check hero title
    await expect(page.locator('h1')).toContainText('Advanced Swimming Analytics');
  ...
  test('should display features section', async ({ page }) => {
    ...
    await expect(page.locator('text=Everything coaches need for swimming analysis')).toBeVisible();
  ...
  test('should display stats section', async ({ page }) => {
    ...
    await expect(page.locator('text=Trusted by coaches worldwide')).toBeVisible();
  ...
  test('should display demo section', async ({ page }) => {
    ...
    await page.locator('text=Everything you need at your fingertips').scrollIntoViewIfNeeded();
    
    // Check demo content
    await expect(page.locator('text=Everything you need at your fingertips')).toBeVisible();
  ...
  test('should display features tabs section', async ({ page }) => {
    ...
    await page.locator('text=Make the right impression').scrollIntoViewIfNeeded();
