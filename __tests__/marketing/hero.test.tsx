...
describe('Hero Component', () => {
  it('renders with default title and description', () => {
    ...
    expect(screen.getByText('Advanced Swimming Analytics for Every Coach')).toBeInTheDocument()
    expect(screen.getByText(/The most advanced platform to analyze, plan and improve your swimming performance/)).toBeInTheDocument()
  })
  ...
  it('renders badge when provided', () => {
    ...
    expect(screen.getByText(/new version of swim app pro available/i)).toBeInTheDocument()
  })

  it('hides badge when set to false', () => {
    render(<Hero badge={false} />)
    
    expect(screen.queryByText(/new version of swim app pro available/i)).not.toBeInTheDocument()
  })
})
