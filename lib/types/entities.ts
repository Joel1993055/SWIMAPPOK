...
export type SessionType = 'aerobic' | 'threshold' | 'speed' | 'technique' | 'recovery'
...
export type TrainingMethodology = 'standard' | 'polarized' | 'pyramidal' | 'block'
...
export type CompetitionType = 'local' | 'regional' | 'national' | 'international'
...
export type AdviceType = 'training' | 'nutrition' | 'recovery' | 'technique' | 'mental' | 'equipment'
...
export type AnalysisType = 'performance' | 'progress' | 'injury_risk' | 'overtraining' | 'technique'
...
export type ReportType = 'weekly' | 'monthly' | 'phase' | 'competition' | 'custom'
...
export type NotificationType = 'training_reminder' | 'competition_alert' | 'achievement' | 'system' | 'social'
