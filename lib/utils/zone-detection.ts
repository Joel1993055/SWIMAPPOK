...
export function detectZoneFromSession(session: { rpe?: number; type?: string; distance?: number }): ZoneType {
...
export function calculateZoneVolumes(sessions: Array<{ rpe?: number; type?: string; distance?: number }>): ZoneData {
